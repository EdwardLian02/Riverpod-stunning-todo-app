...
mixin _$Todo {
  ...
  int get hashCode => Object.hash(runtimeType, id, title, description, category,
      time, priority, isCompleted);

  @override
  String toString() {
    return 'Todo(id: $id, title: $title, description: $description, category: $category, time: $time, priority: $priority, isCompleted: $isCompleted)';
  }
}
...
extension TodoPatterns on Todo {
    ...
    switch (_that) {
      case _Todo() when $default != null:
        return $default(_that.id, _that.title, _that.description,
            _that.category, _that.time, _that.priority, _that.isCompleted);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String id, String title, String description,
            String category, DateTime time, Priority priority, bool isCompleted)
        $default,
  ) {
    final _that = this;
    switch (_that) {
